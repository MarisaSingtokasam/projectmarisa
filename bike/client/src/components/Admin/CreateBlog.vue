<template>
  <div>
    ...
    <div class="header">
      <h3> เพิ่มรายการจักรยาน</h3>
    </div><br><br>
    <div class="container-fluid">
      <div >
        <div >
          <h4> รายละเอียดจักรยาน</h4>
          <br />
          <span class="font2">
            <form v-on:submit.prevent="createBlog">
              <div class="form-group">
                <label for="exampleInputEmail1">ยี่ห้อจักรยาน</label>
              ...
              <br />
              <label for="exampleInputEmail1">รูปจักรยาน</label>
              <div class="blog-tab">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <select v-model="blog.category" required>
                    ...
                    <option value="เสือภูเขา">เสือภูเขา</option>
              ...
              <div class="row">
                ...
                <div class="col">
                  <button
                    ...
                    type="button"
                    style="width: 50%"
                    v-on:click="navigateTo('/inventory')"
                  >
                     ย้อนกลับ
                  </button>
                </div>
